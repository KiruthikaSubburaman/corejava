...
public class SessionState extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(submitValue.equals("result")) {
			...
			RequestDispatcher rd=request.getRequestDispatcher("Result");//navigate from one servlet to another servlet within the same website
			// Cannot also be used for navigating to another website.
